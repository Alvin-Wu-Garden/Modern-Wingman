...
public sealed class GraphRetrievalService
{
        ...
        IReadOnlyList<ExtractedGraphRelationship> relationships)
    {
        ...
        foreach (var relationship in relationships)
        {
            ...
            var fileKey = PropertyText(relationship.Properties, "sourceFile")
                ?? PropertyText(relationship.Properties, "filePath")
                ?? PropertyText(relationship.Properties, "databaseObject")
                ?? PropertyText(relationship.Properties, "xmlPath")
                ?? "(no-file)";
